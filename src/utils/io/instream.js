...
class InStream {
    ...
    read24BitUnsignedInteger() {
        this.offset += 3;
        return ((this.array[this.offset - 3] & 0xFF) << 16) + ((this.array[this.offset - 2] & 0xFF) << 8) + (this.array[this.offset - 1] & 0xFF);
    }
    ...
    readUnsignedSmart2() {
        let b = this.array[this.offset] & 0xFF;
        return b < 128 ? this.readUnsignedByte() - 64 : this.readUnsignedShort() - 49152;
    }
